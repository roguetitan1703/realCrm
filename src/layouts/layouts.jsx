...
export function AppShell({ nav, active, onNav, footer, topbar, children, firmName, logoUrl, sub }) {
  return (
    <div className="app-desktop">
      <Sidebar items={nav} active={active} onNav={onNav} footer={footer} firmName={firmName} logoUrl={logoUrl} sub={sub} />
