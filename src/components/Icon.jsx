...
const P = {
  ...
  // Bubble AND handset. The bubble alone read as a generic chat icon, which is
  // the one thing a WhatsApp button must not look like.
  wa: 'M12 2a10 10 0 0 0-8.6 15l-1.3 4.7 4.8-1.3A10 10 0 1 0 12 2Z M9.2 8.6c.2-.5.4-.5.6-.5h.5c.2 0 .4 0 .6.5l.7 1.6c.1.2 0 .4-.1.6l-.4.5c-.1.2-.2.3-.1.5.3.6 1.3 1.6 1.9 1.9.2.1.4 0 .5-.1l.5-.5c.2-.2.4-.2.6-.1l1.6.8c.4.2.4.4.4.6v.4c0 .3-.3.7-.7.8-.4.2-1 .2-1.6 0-1-.3-2.2-1-3.2-2s-1.7-2.2-2-3.2c-.2-.6-.2-1.2 0-1.6Z',
